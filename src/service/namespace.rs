...
pub struct NamespaceOperationService {}

impl NamespaceOperationService {
    ...
    pub async fn find_all(db: &DatabaseConnection) -> Vec<Namespace> {
        ...
        let mut namespaces: Vec<Namespace> = tenant_infos
            ...
            .map(|tenant_info| {
                ...
                Namespace {
                    ...
                    quota: NamespaceOperationService::DEFAULT_NAMESPACE_QUOTA,
                    config_count: 0,
                    type_: 2,
                }
            })
        ...
        namespaces.insert(
            0,
            Namespace {
                namespace: NamespaceOperationService::DEFAULT_NAMESPACE.to_string(),
                namespace_show_name: NamespaceOperationService::DEFAULT_NAMESPACE_SHOW_NAME
                    .to_string(),
                namespace_desc: NamespaceOperationService::DEFAULT_NAMESPACE_DESCRIPTION
                    .to_string(),
                quota: NamespaceOperationService::DEFAULT_NAMESPACE_QUOTA,
                config_count: 0,
                type_: 0,
