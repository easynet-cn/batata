...
use crate::model::{McpServer, McpServerType};
use crate::registry::mcp::McpServerRegistry;
...
mod tests {
    use super::*;
    use crate::model::{McpCapabilities, McpTransport};
    ...
    fn make_test_server() -> McpServer {
        McpServer {
            ...
            tags: vec![],
            health_status: crate::model::HealthStatus::Unknown,
