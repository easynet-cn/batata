...
async fn get_leader(
    ...
    crate::status::get_leader(req, acl_service).await
}
...
async fn get_peers(
    ...
    crate::status::get_peers(req, acl_service).await
}
...
async fn get_leader_real(
    ...
    crate::status::get_leader_real(req, acl_service, member_manager).await
}
...
async fn get_peers_real(
    ...
    crate::status::get_peers_real(req, acl_service, member_manager).await
}
