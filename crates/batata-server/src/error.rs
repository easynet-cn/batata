...
pub use batata_common::error::{
    ...
    FUZZY_WATCH_PATTERN_OVER_LIMIT, HEALTHY_PARAM_MISS, HEALTH_CHECK_STILL_RUNNING,
    ILLEGAL_NAMESPACE, ILLEGAL_STATE, IMPORT_CONFLICT_ABORT, IMPORT_FILE_EMPTY, IMPORT_FILE_INVALID,
    INSTANCE_ERROR, INSTANCE_METADATA_ERROR, INSTANCE_NOT_FOUND, INVALID_DATA_ID,
    MCP_SERVER_NOT_FOUND, MCP_SERVER_REF_ENDPOINT_SERVICE_NOT_FOUND, MCP_SERVER_VERSION_EXIST,
    MCP_SERVER_VERSION_NOT_FOUND, MEDIA_TYPE_ERROR, METADATA_ILLEGAL, NAMESPACE_ALREADY_EXIST,
    NAMESPACE_NOT_EXIST, NODE_DOWN_FAILURE, NODE_INFO_ERROR, NO_SELECTED_CONFIG,
    ...
    RESOURCE_NOT_FOUND, SELECTOR_ERROR, SERVER_ERROR, SERVICE_ALREADY_EXIST, SERVICE_DELETE_FAILURE,
