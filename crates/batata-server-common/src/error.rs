...
pub use batata_common::error::{
    ACCESS_DENIED, AGENT_NOT_FOUND, AGENT_VERSION_EXIST, AGENT_VERSION_NOT_FOUND, API_DEPRECATED,
    API_FUNCTION_DISABLED, CONFIG_GRAY_NAME_UNRECOGNIZED_ERROR, CONFIG_GRAY_OVER_MAX_VERSION_COUNT,
    CONFIG_GRAY_RULE_FORMAT_INVALID, CONFIG_GRAY_VERSION_INVALID, CONFIG_LISTENER_ERROR,
    CONFIG_LISTENER_IS_NULL, DATA_ACCESS_ERROR, DATA_EMPTY, DATA_VALIDATION_FAILED, EXPORT_NO_DATA,
    FUZZY_WATCH_PATTERN_MATCH_COUNT_OVER_LIMIT, FUZZY_WATCH_PATTERN_OVER_LIMIT,
    HEALTH_CHECK_STILL_RUNNING, HEALTHY_PARAM_MISS, ILLEGAL_NAMESPACE, ILLEGAL_STATE,
    IMPORT_CONFLICT_ABORT, IMPORT_FILE_EMPTY, IMPORT_FILE_INVALID, INSTANCE_ERROR,
    INSTANCE_METADATA_ERROR, INSTANCE_NOT_FOUND, INVALID_DATA_ID, MCP_SERVER_NOT_FOUND,
    MCP_SERVER_REF_ENDPOINT_SERVICE_NOT_FOUND, MCP_SERVER_VERSION_EXIST,
    MCP_SERVER_VERSION_NOT_FOUND, MEDIA_TYPE_ERROR, METADATA_ILLEGAL, NAMESPACE_ALREADY_EXIST,
    NAMESPACE_NOT_EXIST, NO_SELECTED_CONFIG, NODE_DOWN_FAILURE, NODE_INFO_ERROR,
    OVER_CLUSTER_QUOTA, OVER_GROUP_QUOTA, OVER_MAX_SIZE, OVER_TENANT_QUOTA, PARAMETER_MISMATCH,
    PARAMETER_MISSING, PARAMETER_VALIDATE_ERROR, PARSING_DATA_FAILED, RESOURCE_CONFLICT,
    RESOURCE_NOT_FOUND, SELECTOR_ERROR, SERVER_ERROR, SERVICE_ALREADY_EXIST,
